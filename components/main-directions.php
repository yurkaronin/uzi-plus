<section class="main-directions section">
  <div class="wrapper">
    ...
    <ul class="main-directions__list">
      ...
      <li class="main-directions__card main-directions__card--mod">
        <div class="main-directions__content">
          ...
          <div class="main-directions__image">
            <img src="./img/artwork/for-people.svg" alt="рисунок взрослых пациентов в клинике" width="354" height="272">
          </div>
        </div>
      </li>
    </ul>
    ...
    <div class="description">
      <p class="lead">Медицинский центр «УЗИ+» – это частная многопрофильная клиника для взрослых и детей в Смоленске. Мы оказываем широкий спектр услуг по диагностике, лечению и профилактике различных заболеваний.</p>
      <p> Мы уверены в высоком качестве предоставляемых услуг, так как в центре работают только квалифицированные врачи со средним опытом работы более 25 лет, клиника оснащена высокоточным современным диагностическим оборудованием от ведущих мировых производителей, а самое главное - это чуткий подход к решению проблем здоровья каждого пациента.</p>
    </div>
  </div>
</section>
