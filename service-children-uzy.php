    ...
    <div class="wrapper">
      ...
      <div class="service-item__grid">
        <div class="service-item__left">
          ...
          <p class="service-item__text">Эхокардиография назначается терапевтом или кардиологом по показаниям или после
            перенесенного инфаркта, а также всем детям в возрасте одного года и 14 лет в рамках плановой
            диспансеризации. Процедура занимает 15-20 минут и не требует особой подготовки. Но перед обследованием
            рекомендуется избегать физических нагрузок, отказаться от употребления напитков, содержащие кофеин,
            прекратить прием успокоительных препаратов и стимулирующих средств. А если диагностика проводится
            транспищеводным способом, за три часа до процедуры нельзя принимать пищу. </p>
        </div>
