    ...
    <div class="wrapper">
      ...
      <div class="all-reviews__list">
        ...
        <article class="review-item review-item--simple">
          ...
          <div class="review-item__right">
            <blockquote>Так вышло, что несколько лет назад мне пришлось уехать из Смоленска и Москву. С тех пор приезжаю
              ...
              приходится откладывать «на потом». Потом в голову приходят мысли а-ля «а вдруг само пройдет». Понятно, что
              все это только усугубляет возникшую проблему.
              Отсутствие времени делает почти невозможным обращение в несколько разных клиник. Поэтому одним из основных
              ...
              независимых источниках. И если все «срастается», иду туда со спокойной душой.
              Приехал в Смоленск на достаточно длительный срок. После того, как решил все свои вопросы, вспомнил о том,
              ...
              «УЗИ плюс», записался на прием к врачу.
              В назначенный день приехал в один из спальных районов города, где и располагается центр. Сразу после того,
              как вошел в помещение, увидел, как велико количество тех, кто обращается за услугами «УЗИ плюс». А большое
              ...
              специалистам. Теперь мне стало понятно, что в выборе я не ошибся. Осталось только немного подождать, пока
              меня не пригласят на прием.
              Ожидать пришлось совсем недолго. Дверь кабинета открылась, на пороге возникла милая девушка, с улыбкой
              ...
              заинтересованность только в решении вопросов именно моего здоровья, а не опустошения кошелька. Т.е. никто,
              ...
              дни уже сочтены. Никакого драматизма. Это и понравилось…</blockquote>
          </div>
        </article>
        <article class="review-item review-item--simple">
          <div class="review-item__left">
