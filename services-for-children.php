    ...
    <div class="wrapper">
      ...
      <div class="service-item__grid">
        <div class="service-item__left">
          <h2 class="service-item__title">Услуги для детей</h2>
          <p class="service-item__text">В МЦ «УЗИ+» работает дружная команда опытных детских врачей и разработан целый комплекс исследований, помогающий специалистам поставить верный диагноз и назначить эффективное лечение.</p>
          <p>Самое главное для каждого родителя - здоровье его ребенка. Мы собрали первоклассных специалистов, которые используют как старые и проверенные методы лечения, так и новейшие доказанные методики. Врачи «старой закалки» и молодые специалисты идут бок о бок, обучая и обогащая друг друга необходимыми знаниями. Наши врачи стараются найти индивидуальный подход к каждому ребёнку и родителю. Надеемся, что каждый малыш уйдёт от нас только с положительными эмоциями, а родители - с понятным и эффективным лечением для своего крохи.</p>
        </div>
